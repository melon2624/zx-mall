...
public class StoreUserQueueService {
    ...
    public void pushUser(StoreUserSendMessage storeUserSendMessage, String waiterId) {
        ...
        if (redisClient.listSize(storeReceiveUserListKey) < CONSUME_SIZE) {
            redisClient.remove(storeReceiveUserListKey, userWaiterRelation);
            ...
            redisClient.remove(publicStoreReceiveUserListKey, userWaiterRelation);
