package com.zx.framework.web.tool.excel;
...
public class ExportExcelAspect {
    ...
    @Around("@annotation(com.zx.framework.web.tool.excel.ExportExcel)")
    public Object around(ProceedingJoinPoint point) throws Throwable {
        ...
        if (rawType == IPage.class) {
            ...
            Assert.notNull(pageDTO, method.getName() + "接口返回值为page，入参对象必须继承com.zx.edu.core.common.model.PageDTO");
